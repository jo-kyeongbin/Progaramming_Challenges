...
입력 각 줄에 있는 단어 수와 (공백을 제외한) 글자 수를 세어 출력하라. 한 줄에는 공백 포함 최대 1024글자가 있고, 단어는 공백으로 분리되어 있다. 몇 줄이 들어올지는 미리 알 수 없으므로 EOF를 체크해야 한다. 
...
10진수는 평범하게 표기하고, 16진수는 앞에 0x를 붙여서 표기한다. 각 줄에는 10진수 혹은 16진수 숫자가 씌여 있다. 
